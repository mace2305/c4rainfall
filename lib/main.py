...
# dir link: /home/yixiang/Documents/work_dir/past_workflow/5_early_Dec_projectorganization-packaging-Git_evaluation_bootstrapping/bbox_extents/NESW_candidates
domains_inter_mon = [
...
domains_SW_mon = [
    ...
    [-30.0, 30.0, 65.0, 140.0], [-30.0, 32.0, 75.0, 148.0], [-30.0, 42.0, 75.0, 138.0], [-4.0, 8.0, 93.5, 114.0], 
...
domains_NE_mon = [
    ...
    [-6.0, 10.0, 96.0, 111.5], [90.0, 120.0, -10.0, 14.0]
]
...
for i,d in enumerate((domains_NE_mon, domains_SW_mon, domains_inter_mon)):
    perms = [(dims, seq_strings[i], hpparam) for dims in domains_NE_mon]
    print(f'\nFor {seq_strings[i]}:')
