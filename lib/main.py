...
domains_NE_mon = [
    ...
    # [-6.0, 10.0, 96.0, 111.5], [-10.0, 14.0, 90.0, 120.0]
]
...
domains_inter_mon = [
    # [-10.0, 20.0, 90.0, 150.0], [-12.0, 28.0, 90.0, 140.0], [-13.5, 29.5, 92.0, 138.0], 
    [-4.0, 8.0, 93.5, 114.0], 
...
seq_strings = ("inter_mon", "SW_mon", "NE_mon")

for i,d in enumerate((domains_inter_mon, domains_SW_mon, domains_NE_mon)):
